                            ...
                            <li class="splide__slide">
                                <div class="seccion-titular__info--music">
                                    ...
                                    <div class="seccion-titular__info--text">
                                        ...
                                        <a class="seccion-titular__info--artista">Lyn</a>
            ...
            <div class="zona-reproductor">
                ...
                <div class="controls">
                    <button class="player-button">
                        <img src="/assets/img/icons/boton-shuffle.svg">
                    </button>
                    <button class="player-button"
                    style="-webkit-transform: scaleY(-1);  
                    transform: scaleX(-1);">
                        <img src="/assets/img/icons/boton-next.svg">
                    </button>
                    <button class="player-button-play" onclick="toggleAudio()">
                        <img id="play" src="/assets/img/icons/boton-play.svg">
                    </button>
                    <button class="player-button">
                        <img src="/assets/img/icons/boton-next.svg">
                    </button>
                    <button class="player-button" onclick="repetirAudio()">
                        <img id="repeat" src="/assets/img/icons/boton-repeat.svg">
                    </button>
                </div>
                <audio src="/assets/audio/Dion - The Wanderer.mp3" id="reproductor-de-audio"></audio>
            </div>
            <div id="volumen">
